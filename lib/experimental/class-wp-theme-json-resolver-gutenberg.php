	...
	public static function get_theme_data( $deprecated = array() ) {
		...
		if ( null === static::$theme ) {
			...
			if ( wp_get_theme()->parent() ) {
				...
				$original_parent_theme_json = new WP_Theme_JSON_Gutenberg( $parent_theme_json_data );
				gutenberg_register_webfonts_from_theme_json( $original_parent_theme_json->get_settings() );
